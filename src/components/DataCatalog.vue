<template>
  <div class="data-catalog h-full bg-gray-800 p-4 overflow-auto">
      ...
      <label for="file-upload" class="block">
        ...
        >
          ...
          <input
            ...
            class="hidden-input block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-green-700 hover:file:bg-green-100 rounded"
          />
        </div>
      </label>
      <!-- <button
    ...
    <div id="fileList">
      ...
      <p v-if="fileStore.importedFiles.length === 0" class="text-gray-400">
        No files imported yet.
      </p>
      <ul v-else class="space-y-4">
        <li
          v-for="file in fileStore.importedFiles"
          :key="file.tableName"
          class="bg-gray-700 p-4 rounded shadow"
        >
          <div class="table-item">
            ...
            <div v-if="file.showSchema" class="schema-display mt-2">
              ...
              <p v-else-if="file.schemaError" class="text-red-500">
                {{ file.schemaError }}
              </p>
            </div>
